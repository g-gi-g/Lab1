...
namespace MarketplaceWebApplication.Controllers
{
    public class NotificationTypesController : Controller
    {
        ...
        public NotificationTypesController(DbmarketplaceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] NotificationType notificationType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] NotificationType notificationType)
        {
